...
abstract contract TestSuits {
    ...
    Types.TBVContracts internal TBV_CONTRACTS = Types.TBVContracts({
    ...
    Types.UniswapFlashSwapTestCaseParams internal UNISWAPV4_FLASH_SWAP_TEST0 = Types.UniswapFlashSwapTestCaseParams({
        tbvContracts: TBV_CONTRACTS,
        liquidation: Types.Liquidation({
            blockNumber: 11141103, borrower: address(0x4D1Ef18305EAe34Eaf3A7c227715A42813d667dA)
        })
    });
}
