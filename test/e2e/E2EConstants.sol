...
library E2EConstants {
    ...
    // Arbitrageur (Anvil account[2]) — genesis-funded so the bot has gas the
    // instant it boots (the setup spawns it via FFI before forge broadcasts any
    // funding tx). Matches env.arbitrageur.example.
